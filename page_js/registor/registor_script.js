                ...
                function registering() {
                    ...
                    if (registor_call === 1) {
                        ...
                        function finish_window(){
                            ...
                            get_paste_place.innerHTML = data_information[1] + ", поздравляем! Ваш аккаунт успешно был создан на фриланс бирже Bestlancer. Теперь вы смело можете заходить в ваш аккаунт и развивать его. Благодорим вас, за сделаный вами выбор!";
                            //button_click
