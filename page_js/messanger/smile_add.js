function smile_add(){
    ...
    get_icon.addEventListener("click", function (){
        const get_form_child = document.querySelector(".user_chat form .form_children_wrapper");
        const get_smile_container = document.querySelector(".user_chat form .smile_choice");
    ...
    //smile_choice
    const get_smiles = document.querySelectorAll(".user_chat form .smiles div");
    get_smiles.forEach( (item) => {
        item.addEventListener("click", function (){
            const get_value_tag = document.querySelector(".user_chat form textarea");
