...
<body>
    ...
    <div class="header_line">
        <div class="line_wrapper">
            <div class="header_part header_part_one">
                <div>
                    <h1><a href="../bd_send/user_sing_in.php">
                            <p>best</p>lancer
                        </a></h1>
                </div>
                <div class="links">
    ...
    <div class="freelance_container container">
        ...
        <div class="about_us">
            ...
            <div class="about">
                <p class="about_text">Добро пожаловать на BestLancer - лучшую фриланс-биржу для воплощения ваших
                    проектных идей в реальность!</p>
            ...
            <div class="about">
                <div>
                    <p>
                        ...
                        Мы создали Kwork, чтобы помочь таким независимым и ориентированным на результат
                        предпринимателям, как вы, найти талантливых фрилансеров для всех нужд вашего бизнеса.
                        На Kwork тысячи талантливых фрилансеров соревнуются за ваш бизнес, размещая свои услуги в
                        Каталоге. Эти услуги продаются как удобные товары навынос в реальном магазине. На нашей
                        платформе нет запутанных и дорогостоящих почасовых ставок.
                        Также больше не нужно торговаться по цене и срокам. Цены, сроки и включенные услуги
                        оговариваются заранее, что экономит ваше время, деньги и энергию.
                        Вы можете с уверенностью покупать услуги фрилансера на Kwork. Если что-то пойдет не так, вы
                        защищены нашей <b>100% гарантией возврата денег , единственной в своем роде Программой защиты
                            покупателей</b> и невероятной службой поддержки.
                ...
                <div>
                    ...
                    <p>Разместите запрос покупателя в специально созданном разделе «Обмен»!
                        ...
                        крупных проектов.
                        Качество предложений на Kwork уникально. Благодаря запатентованной функции нашей платформы вам
                        не нужно просматривать море общих предложений, которые вы могли бы получить на других платформах
                        для фрилансеров. Поскольку профессионалы Kwork вознаграждаются за то, что они вкладывают в
                        каждое предложение особую мысль и усилия, вы можете выбирать из лучших вариантов .
