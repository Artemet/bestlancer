<div class="user_container finish_order_container">
        ...
        <div class="finish_wrapper">
            <div>
                ...
                <textarea name="thirst_message" class="right_in" id="" cols="30" rows="10"
                    placeholder="Введите слова благодарности, или что-то другое (по желанию)"></textarea>
            </div>
            <div class="checkbox_agree">
                ...
                <div>
                    <p>Я принимаю работу продовца и понимаю, <br> что возврат средств уже будет невозможен.</p>
                </div>
            </div>
        </div>
