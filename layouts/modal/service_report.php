<div class="user_container make_report_container">
    ...
    <script>
        $('button.send_report').on('click', function (){
            ...
            $.ajax({
                method: "POST",
                url: "../bd_send/report_send.php?service_id=<?=$service_id?>",
                ...
                .done(function () {
                    ...
                    setTimeout(() => {
                        ...
                        alert("Жалоба на услугу №<?=$service_id?> успешно подана. Вскоре мы её рассмотрим и сделаем вывод, благадорим за заявку!");
                    }, 500);
                });
        });
    </script>
