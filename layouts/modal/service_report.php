<div class="user_container make_report_container">
    <div class="make_report">
        <div>
            ...
            <form action="../bd_send/services/service_report.php?service_id=<?=$service_id?>" method="post">
                <div class="option_choice">
                    <input type="text" class="right_in" name="report_option" readonly>
                    <div class="sub_input">
                ...
                <div>
                    <textarea name="report_description" class="right_in" id="" cols="30" rows="10" placeholder="Напишите вашу жалобу"></textarea>
                </div>
