<div class="user_container user_account">
    ...
    <div class="come_in sing_in">
        <h2>Вход</h2>
        <div class="line"></div>
        <form action="../bd_send/user_sing_in.php" method="post">
            <div>
                <p>Ваш ник-нейм:</p>
                <u class="warning"></u>
                <input type="text" class="right_in come_in_nik" name="nik_name" placeholder="Напишите ваш ник">
            </div>
            <div>
                <p>Ваш Пароль:</p>
                <div class="password">
                    <u class="warning"></u>
                    <input type="password" class="right_in come_in_password" name="password"
            ...
            <div class="button" onclick="value_check_two()">
                <button class="buttons">Войти</button>
            </div>
            <div class="button" onclick="value_check_two()">
                <p class="buttons">Войти</p>
            </div>
        </form>
        <!-- <script>
            $(document).ready(function(){
                $('.come_in button').on('click', function() {
                    console.log(0);
                    var nik_value = $('input.come_in_nik').val();
                    var password_value = $('input.come_in_password').val();
                    $.ajax({
                        method: "POST",
                        url: "../bd_send/user_sing_in.php",
                        data: { nik: nik_value, password: password_value }
                    });
                    .done(function( msg ) {
