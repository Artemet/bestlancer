        ...
        <form action="../bd_send/user_registor.php" method="post" class="registor_form">
            <div class="registor_blocks">
                ...
                <div>
                    ...
                    <div class="password">
                        <u class="warning"></u>
                        <input type="password" class="right_in password_input" name="user_password"
                            placeholder="Напишите ваш Пароль">
                        <div class="eye" onclick="password_consequences()">
                            <svg class="show" xmlns="http://www.w3.org/2000/svg" height="1em"
                            ...
                            <svg class="show_none" xmlns="http://www.w3.org/2000/svg" height="1em"
                ...
                <div>
                    ...
                    <div class="country">
                        <u class="warning"></u>
                        <input type="text" readonly class="right_in country" name="user_country"
                            placeholder="Напишите вашу страну">
                        <div class="menu">
                            <div>
                                <p>Абхазия</p>
                            </div>
                ...
                <div>
                    ...
                    <div class="age">
                        <u class="warning"></u>
                        <input type="number" name="user_age" class="right_in age_input" value="20" readonly
                            placeholder="Напишите ваш возраст">
                ...
                <div>
                    ...
                    <div class="skills">
                        <u class="warning"></u>
                        <input type="text" name="user_skills" readonly class="right_in skills"
                            placeholder="Выберите ваши умения">
                        <div class="menu">
                            <div>
                            ...
                            <div>
                                <p>Транспортный-дизайнер</p>
                            </div>
                            <div>
                                <p>Изготовитель-моделей</p>
                            </div>
                            <div>
                                <p>Продуктовый-дизайнер</p>
                            </div>
                            <div>
                                <p>Дизайнер-мобильных-приложений</p>
                            </div>
                            <div>
                            ...
                            <div>
                                <p>Производственный-бизнес</p>
                            </div>
                            <div>
                                <p>Коммерческий-бизнес</p>
                            </div>
                            <div>
                                <p>Финансовый-бизнес</p>
                            </div>
                            <div>
                                <p>Посреднический-бизнес</p>
                            </div>
                            <div>
                                <p>Страховой-бизнес</p>
                            </div>
                            <div>
                                <p>Домашнее-обучение</p>
                            </div>
                            <div>
                                <p>Репетитор-на-полный-день</p>
                            </div>
                            <div>
                                <p>Репетитор-на-неполный-день</p>
                            </div>
                            <div>
                                <p>Написание-продающих-текстов</p>
                            </div>
                            <div>
                                <p>Имиджевый-копирайтинг</p>
                            </div>
                            <div>
                                <p>SEO-копирайтинг</p>
                            </div>
                ...
                <div>
                    ...
                    <textarea name="about_user" placeholder="Расскажите о себе и опыте работы" class="right_in"
                        cols="30" rows="10"></textarea>
                </div>
                <div class="users_works">
                    <div class="add_works">
                        <div>
                            <p class="title">Добавьте примеры работ</p>
                        </div>
                    ...
                    <textarea name="user_projects" readonly placeholder="Итоговые работы" class="final_resolt right_in"
                        cols="30" rows="10"></textarea>
                </div>
                ...
                <div class="user_money">
                    ...
                    <div class="hour_money">
                        <div><input type="number" name="user_price" min="5" value="5" class="right_in money"
                                placeholder="Введите суму"></div>
