        ...
        <form action="../bd_send/user/user_information.php" class="change_information_form" id="userForm" method="post" enctype="multipart/form-data">
            <div class="img_change">
                ...
                <div class="img" id="selectedIcon">
                    ...
                    <div>
                        <div>
                            <input type="file" id="icon_choice" name="icon_choice" class="choose_file" accept=".jpg,.png,.jpeg">
            ...
            <div class="wrapper">
                ...
                <div>
                    <h3>Обо мне</h3>
                    <textarea name="about_me" class="right_in about_user" id="" cols="30" rows="10" placeholder="Измините информацию о себе"></textarea>
                </div>
            </div>
