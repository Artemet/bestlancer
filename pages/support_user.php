...
<div class="support_container container header">
    ...
    <div class="support_part">
        <form action="../email_send/support_email.php" method="post" enctype="multipart/form-data">
            ...
            <div>
                <p>Сообщение</p>
                <textarea name="message" class="right_in" cols="30" placeholder="Текст сообщения для службы поддержки"
                    rows="10"></textarea>
            </div>
            <div>
                <p>Прикрепите файл</p>
            ...
            <div class="button_choice"><button type="submit">Отправить</button></div>
        </form>
    </div>
</div>
<?php
