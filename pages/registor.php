...
<div class="registor_container container">
        ...
        <div class="main_registration">
            ...
            <div class="line_block">
                <div>
                    <h3>Имя</h3>
                    <u class="warning"></u>
                    <input type="text" name="user_name" placeholder="Имя" class="right_in checking_value"
                        id="input_name">
                </div>
                <div>
                    <h3>Фамилия</h3>
                    <input type="text" name="user_family" placeholder="Фамилия (по желанию)" class="right_in"
                        id="input_surname">
                </div>
            </div>
            ...
            <div class="input_part password_value">
                ...
                <div class="eye"><svg xmlns="http://www.w3.org/2000/svg" height="16" width="20"
    ...
    <div class="end_registor_question question" id="3">
        ...
        <div class="end_registration">
            ...
            <div>
                <p class="information_text">Придумайте латинский никнейм, по которому другие пользователи будут <br>
                    видеть ваш аккаунт. Пример никнейма: Artem308.</p>
            </div>
        </div>
        <div class="post_button">
