    ...
    <div class="header">
        ...
        <div class="main_make">
            ...
            <div class="form_part">
                ...
                <input type="file" name="file_send" class="file_choice right_order">
            </div>
            ...
            <div class="form_part category_part">
                ...
                <div class="inputs">
                    <div class="main_category input_block" id="0"><input type="text" name="main_order_category" id="0"
                            class="right_order check_value category_input" placeholder="Выбирите категорию" readonly>
                    </div>
