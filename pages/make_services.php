    ...
    <div class="header">
        ...
        <form action="../bd_send/services/send_service.php" method="post" enctype="multipart/form-data">
            <div class="form_part">
                ...
                <input type="text" name="category" class="category_menu right_in" readonly>
            ...
            <div class="form_part">
                ...
                <textarea name="service_information" class="right_in" placeholder="Опишите свою услугу" id="" cols="30" rows="10"></textarea>
            </div>
            <div class="form_part money_part">
                <b class="input_name">Цена услуги</b>
                <div>
                    <input type="number" name="service_price" class="right_in" min="5" placeholder="Введите среднию цену услуги">
