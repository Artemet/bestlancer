...
<div class="reviews_company container">
    <h2 class="header_title">отзывы<div class="bestlancer_text"><p>BEST</p>LANSER</div></h2>
    ...
    <div class="reviews">
        ...
        <?php
            ...
            // Check if the logged-in email has matching reviews after processing all reviews.
            if ($hasMatchingEmail && $emailsCount[$loggedInEmail] > 1) {
                ...
                <div class="close_warning" title="Закрыть увидомление">
