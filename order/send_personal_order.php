...
$order_sql = "INSERT INTO `notifications` (`id`, `order_name`, `order_information`, `order_file`, `order_nik`, `nik`, `time`, `date`, `type`) VALUES (NULL, '$order_name', '$order_information', '$file_name', '$order_nik', '$nik', '00:00:00', '5 мая', 'personal')";
